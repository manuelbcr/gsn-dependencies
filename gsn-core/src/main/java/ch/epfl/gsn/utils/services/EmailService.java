 ...
 * The implementation is based on the Apache commons Email library @see
 * http://commons.apache.org/email/
 * Prior to use this service, you MUST configure the SMTP server (postfix,
 * gmail, ...) which will send your emails.
...
public class EmailService {
    ...
    /**
     * This method cover most of the cases of sending a simple text email. If the
     * email to be sent has to be configured
     * in a way which is not possible whith the parameters provided (such as html
     * email, or email with attachement, ..),
     * please use the {@link #sendCustomEmail(org.apache.commons.mail.Email)} method
     * and refer the API
     * {@see http://commons.apache.org/email/}.
     *
     * @param to      A set of destination email address of the email. Must contain
    ...
    /**
     * This method send a user configured email
     * {@link org.apache.commons.mail.Email} after having updated the
