...
public class User {
    ...
    private String isCandidate = "no";// if isCandidte = yes, it means that user has alredy signed-up and is waiting
                                      // for Admin confirmation to become a real user */
    private String isWaiting = "no";// if isWaiting = yes, it means that user has modified(added, changed, deleted)
                                    // his access right for a virtual sensor or a group and waits for Owner/Admin
                                    // decision
    ...
    public User(String userName, String password, String firstName, String lastName, String email, Vector groupList,
            String isCandidate) {
        this.userName = userName;
        this.password = password;
    ...
    /*
     * given the name of a virtual sensor, checks if the user can read its output
     * stream
     */
