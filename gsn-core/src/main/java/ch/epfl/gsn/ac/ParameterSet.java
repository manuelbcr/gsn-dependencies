...
public class ParameterSet {
    ...
    /*
     * if a parameter has more than one value, given the name of the parameter,
     * returns a Vector of its values
     */
    ...
    /*
     * make a DataSource(virtual sensor name, access right) object using parameters
     * of a file uploading form
     */
