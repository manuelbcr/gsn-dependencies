...
public class Group {
	...
	private String groupType = "n"; // group type defines the statut of a group as (add :if a user wants to add the
									// group but still waits for Admin decision, delete: if a user wants to delete a
									// group but still waits for Admin decision, n : normal)
	...
	/*
	 * given the name of a virtual sensor, returns true if at least one of the
	 * DataSources in the group has read access right for it
	 */
	...
	/*
	 * given the name of a virtual sensor, returns true if at least one of the
	 * DataSources in the group has write access right for it
	 */
	...
	/*
	 * given the name of a virtual sensor, returns true if at least one of the
	 * DataSources in the group has resd/write access right for it
	 */
