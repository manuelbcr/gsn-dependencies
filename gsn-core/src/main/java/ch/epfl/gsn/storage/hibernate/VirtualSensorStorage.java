...
public interface VirtualSensorStorage {
     ...
     * @throws GSNRuntimeException if the {ch.epfl.gsn.beans.StreamElement} could
     *                             not be stored (for instance due to a constraint
     *                             violation).
     */
     ...
     * @return the StreamElement associated to the pk primary key or null if it does
     *         not exists.
